...
#define SETTINGS_DEFAULT_NUM_OF_STAIRS              17
#define SETTINGS_DEFAULT_MAX_PWM                    MAX_PWM_DUTY
#define SETTINGS_DEFAULT_STAIR_LIGHT_ON_TIME_MS     10000
#define SETTINGS_DEFAULT_SELECTED_EFFECT_NUMBER     1
#define SETTINGS_DEFAULT_EFFECT_1_SETTINGS_1        10
#define SETTINGS_DEFAULT_EFFECT_1_SETTINGS_2        2000
